...
<Grid container spacing={2} xs={12} sx={{justifyContent:mobile?'flex-end':'',marginBottom:mobile?'26px':'',marginTop:mobile?'26px':''}}>
      <Grid item>
      <a href="https://www.instagram.com/slushie_in/" target="_blank" rel="noopener noreferrer">
        <SvgIcon component={InstagramIcon} href={'https://www.instagram.com/slushie_in/'} sx={{ width: mobile?"26px":'36px',height:mobile?"26px":'36px' ,color: '#E4405F' }} />
      </a>
      </Grid>
      <Grid item>
      <a href="https://www.facebook.com/profile.php?id=100094909293495" target="_blank" rel="noopener noreferrer">
